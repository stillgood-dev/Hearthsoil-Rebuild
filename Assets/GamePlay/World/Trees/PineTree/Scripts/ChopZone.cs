...
public class ChopZone : MonoBehaviour
{
    ...
    [SerializeField] private FelledLogController logController;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        logController?.SetPlayerInChopZone(true, playerAxeController);
    }
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        logController?.SetPlayerInChopZone(false, playerAxeController);
    }
}
